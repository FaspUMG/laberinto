...
public class Laberinto {
    ...
    public Laberinto() {
        LaberintoPropiedades propiedades = new LaberintoPropiedades();
    ...
    public int[] moverArriba(char[][] laberinto, int[] jugador) {
        return jugador;
    }
    
    public int[] moverAbajo(char[][] laberinto, int[] jugador) {
        return jugador;
    }
    
    public int[] moverDerecha(char[][] laberinto, int[] jugador) {
        return jugador;
    }
    
    public int[] moverIzquierda(char[][] laberinto, int[] jugador) {
        return jugador;
    }
